...
from management.forms.forms import FilterForm
...
class DashboardListView(ListView):
    model = CustomerInfo
    template_name = 'management/dashboard_list.html'
...
def export_csv(request):
    ...
    for r in qs:
        writer.writerow([
            r.id, r.full_name, dict(CustomerInfo.GENDER_CHOICES).get(r.gender, r.gender),
            r.phone_number, r.id_card,
